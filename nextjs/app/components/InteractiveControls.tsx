...
export function NewsletterForm() {
  ...
  return (
    ...
    >
      <label className="text-sm font-bold" htmlFor="next-newsletter">
        Morning brief
      </label>
      <div className="flex gap-2">
        <input id="next-newsletter" type="email" placeholder="email@example.com" className="min-w-0 flex-1 border border-[var(--rule)] bg-white px-3 py-2 text-sm" />
