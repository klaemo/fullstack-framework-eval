...
export const homepage = {
  ...
  topStories: [
    {
      section: 'Business',
      title: 'Chip demand redraws the server map',
      href: '/articles/cities-prepare-hotter-denser-decade',
    },
    {
      section: 'Culture',
      title: 'Streaming bundles start to look like cable',
      href: '/articles/cities-prepare-hotter-denser-decade',
    },
    {
      section: 'Science',
      title: 'Ocean sensors reveal faster coastal warming',
      href: '/articles/cities-prepare-hotter-denser-decade',
    },
  ] satisfies StoryLink[],
  latest: [
    {
      time: '08:15',
      title: 'Election officials test new audit process',
      href: '/articles/cities-prepare-hotter-denser-decade',
    },
    {
      time: '07:50',
      title: 'Airlines add summer capacity on regional routes',
      href: '/articles/cities-prepare-hotter-denser-decade',
    },
    {
      time: '07:20',
      title: 'Researchers publish battery recycling benchmark',
      href: '/articles/cities-prepare-hotter-denser-decade',
    },
